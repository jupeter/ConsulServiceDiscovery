...
namespace ConsulServiceDiscovery
{
    public class ConsulHostedService : IHostedService
    {
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            if(ip == null)
            {
                ...
                throw new ConsulHostedException("Could not find instance host IP. ");
            }
            ...
            var registration = new AgentServiceRegistration()
            {
                ...
                {
                    HTTP = $"{uri.Scheme}://{ip}:{uri.Port}/hc",
            ...
            _logger.LogInformation($"{uri.Scheme}://{ip}:{uri.Port}/hc");
    ...
    public class ConsulHostedException : Exception
    {
        public ConsulHostedException(string message)
        : base(message)
        {
        }
    }
